      ...
      options: [
        ...
        },
        {
          ...
          imageURL:
            "https://images.unsplash.com/photo-1460925895917-afdab827c52f?q=80&w=2015&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
          details: `
          <p class="font-inter"><span class="ql-size-large">Future-proof your digital landscape with our platform consulting services. We create robust strategies, simplify processes, and reduce costs, merging modern tech with your existing legacy systems.</span></p>
          <p><br></p>
          <p class="font-inter">Businesses need to accelerate digitally to keep up with competition and fulfill customer needs. Slow efforts can result in high platform costs, sluggish growth, scalability issues, customer loss, and IT challenges in integrating new technologies.</p>
          <p><br></p>
          <p class="font-inter">At Youwe, we're here for you. We optimize your digital environment, modernize where necessary. With over 23 years of experience, we craft a thoughtful plan to propel your systems into the future. We reduce complexity without compromising quality or performance. Our approach is designed to foster continuous advancement across all fronts – from empowering individuals, refining processes, to harnessing cutting-edge technology.</p>
        `,
        },
        {
          ...
          imageURL:
            "https://images.unsplash.com/photo-1460925895917-afdab827c52f?q=80&w=2015&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
          details: `
          <p class="font-inter"><span class="ql-size-large">Looking for ways to add value with AI to your business? Our seasoned AI experts assess your company's readiness for AI integration and propose actionable AI projects, tailored to bring immediate value. From automating processes to improved decision-making or personalizing customer experiences. Learn how we can help you adopt AI the right way.</span></p>
          <p><br></p>
          <p class="font-inter">Our focus is on transforming key areas within your organization, particularly those that impact your most vital operations. By implementing modern AI models, we significantly reduce costly manual labour while enhancing both accuracy and effectiveness.</p>
          <p><br></p>
          <p class="font-inter">Our expertise in AI consulting is deep-rooted and wide-ranging, encompassing the latest advancements in large language models and machine learning. With a seasoned team dedicated to leveraging these technologies, Youwe ensures your enterprise not only keeps pace with industry innovations but also achieves substantial operational efficiencies and a competitive edge in the market.</p>
        `,
        },
      ],
    },
      ...
      options: [
        ...
        },
        {
          ...
          imageURL:
            "https://images.unsplash.com/photo-1549923746-c502d488b3ea?q=80&w=2071&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
          details: `
          <p class="font-inter"><span class="ql-size-large">Blending creativity with business insight, Youwe's front-end solutions shape touchpoints that reflect your brand and optimize conversions.</span></p>
          <p><br></p>
          <p class="font-inter">Building a consistent digital experience is quite challenging. You want to grow and still maintain your brand's recognition everywhere. This becomes even more challenging as technology and user expectations change.</p>
          <p><br></p>
          <p class="font-inter">At Youwe, we understand this. That's why we employ composable design and headless solutions. We thoroughly test everything to ensure smooth functionality across all devices. With our tools, like front-end development and modern JavaScript frameworks, we lay a solid foundation. This way, we ensure a recognizable brand presence wherever your audience is, helping you build trust and loyalty with your customers.</p>
        `,
        },
      ],
    },
      ...
      options: [
        {
          ...
          details: `
          <p class="font-inter"><span class="ql-size-large">Are you in search of a dependable eCommerce partner? Youwe provides tailored services to boost your online sales and operations. We prioritize delivering measurable outcomes via strong platforms and user-oriented experiences.</span></p>
          <p><br></p>
          <p class="font-inter">Experience the benefits of a flexible e-commerce landscape with fast time-to-market and a balanced blend of short-term impact and long-term revenue. As a technology-agnostic agency, we work with proven commerce platforms, from easy-start solutions to building a fully composable commerce business.</p>
          <p><br></p>
          <p class="font-inter">We are determined to do what's right for your business: we focus on delivering results while ensuring a future-proof foundation. Our people are valued for their strategic approach and hands-on mentality. Whether you need assistance in selecting the right platform, developing a conversion-focused strategy or ensuring optimal SEO performance, your team will be tailored to your needs, aligned with the stage of your digital journey.</p>
        `,
        },
        {
          ...
          imageURL:
            "https://images.unsplash.com/photo-1586880244543-0528a802be97?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
          details: `
          <p class="font-inter"><span class="ql-size-large">Get a firm grip on your master data and product information management (PIM). Our focus is on making data architecture simple and practical. Designed to help your business become digitally mature.</span></p>
          <p><br></p>
          <p class="font-inter">A PIM or MDM system prevents data inconsistencies and improves decision-making through reliable information. A must-have for commercial organizations, it ensures efficient operations and leads to satisfied customers. Meet their expectations, as well as those of partners, with seamless integration of master data.</p>
          <p><br></p>
          <p class="font-inter">At Youwe, we simplify your data management with our PIM and MDM solutions. We optimize your data, aligning it with industry standards such as GS1, ETIM, or eClass when necessary. We foster collaboration between departments and platforms, saving you valuable time. Whether you're distributing product information or improving your product lifecycle, we ensure high-quality data to help you achieve your goals quickly and efficiently.</p>
        `,
        },
        {
      ...
      options: [
        {
          ...
          details: `
          <p class="font-inter"><span class="ql-size-large">Boost your organic traffic and conversions with our data-driven SEM services. With your unique data as our starting point, we build a strong online visibility that results in sustainable traffic growth.</span></p>
          <p><br></p>
          <p class="font-inter">Without effective search engine optimization and search advertising, your website can get lost in the vast amount of online content and struggle to reach its audience. Poor SEO and SEA result in less traffic, conversions and ultimately less revenue.</p>
          <p><br></p>
          <p class="font-inter">Our SEO services provide a direct solution to your search engine challenges. We utilize data-driven strategies to enhance your visibility, generate organic traffic, and improve conversions. Your website will rise in Google search results, effectively reaching your target audience. Together, we can turn your SEO weaknesses into strengths, making your business more competitive and future-ready in the ever-evolving digital market.</p>
        `,
        },
        {
          ...
          imageURL:
            "https://images.unsplash.com/photo-1477013743164-ffc3a5e556da?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
          details: `
          <p class="font-inter"><span class="ql-size-large">Optimize your digital results with conversion optimization. Our data-driven CRO experts ensure continuous improvements, leading to consistent growth in your results. No random adjustments, but based on thorough data analysis. This is how you achieve measurable success.</span></p>
          <p><br></p>
          <p class="font-inter">Are you investing a lot of time, money, and energy in driving traffic to your online store without seeing additional sales as a result? Or have you created amazing user experiences but don't see this reflected in conversions? We have the solution. With a data-driven approach, we improve your online results.</p>
          <p><br></p>
          <p class="font-inter">Effectively implement CRO with our approach: analyze user behavior, identify obstacles, and design A/B tests based on solid hypotheses. Track progress in a real-time dashboard, where the winning test becomes the starting point for further optimization. We train your team to make better and informed decisions. With CRO as our guide, we enhance your online ROI.</p>
        `,
        },
        {
          ...
          imageURL:
            "https://images.unsplash.com/photo-1477013743164-ffc3a5e556da?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
          details: `
          <p class="font-inter"><span class="ql-size-large">No fluff, just performance with our result-driven marketing services. Partner with us and attract the right audience and convert them into loyal customers. Every action, every creative, and every campaign is optimized for results.</span></p>
          <p><br></p>
          <p class="font-inter">Performance marketing on platforms like Google, Facebook, Bing, and LinkedIn is challenging due to rising costs and fluctuating results, despite promising AI technologies. A familiar challenge for many.</p>
          <p><br></p>
          <p class="font-inter">Youwe combines marketing expertise and engineering skills. We focus solely on what truly works and enhance your campaigns across all platforms for maximum returns. Whether you're advertising on Google, Amazon, or multiple channels simultaneously, our approach revolves around clear strategies and tangible outcomes.</p>
        `,
        },
        {
          ...
          imageURL:
            "https://images.unsplash.com/photo-1477013743164-ffc3a5e556da?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
          details: `
          <p class="font-inter"><span class="ql-size-large">Master e-commerce with Product Feed Marketing. Efficiently distribute and fine-tune product data and exchange order information on marketplaces like Amazon, eBay, and Zalando to maximize conversions.</span></p>
          <p><br></p>
          <p class="font-inter">Marketplaces like Amazon, eBay and Zalando offer growth opportunities, but also present challenges. Each marketplace has unique rules and regulations, making the integration and management of product data time-consuming. Additionally, overseeing orders, inventory and customer service adds extra complexity.</p>
          <p><br></p>
          <p class="font-inter">Our marketplace integration service simplifies the sales process. With advanced integration software and mapping templates, we swiftly and accurately synchronize product data across multiple marketplaces. Automating the sales process reduces manual tasks, enabling easy inventory management, order processing, and consistent customer service. This allows businesses to focus on sustainable, cross-border growth.</p>
        `,
        },
      ],
    },
                ...
                <div className="z-[1] max-w-full gap-x-32 space-y-24 px-5 sm:px-8 lg:px-12 xl:mx-auto xl:flex xl:max-w-[1200px] xl:space-y-0 xl:px-0">
                  <section className="h-fit space-y-11 sm:mr-32 md:mr-52 lg:mr-0 lg:w-2/3 xl:sticky xl:top-40 xl:w-[420px]">
                    <div className="space-y-2">
                      {/* Slide heading */}
                      <h2 className="mt-3 text-4xl font-semibold max-xl:line-clamp-2 sm:text-5xl">
                        {service.heading}
                      </h2>
                      {/* Slide description */}
                    ...
                    <div className="space-y-4">
                      {service.options.map((option, optionIndex) => {
                        return (
                          <div
                            className={`flex h-16 max-w-96 cursor-pointer items-center rounded-xl border border-neutral-500 bg-cover bg-center px-5 transition-[filter] duration-500 ease-in-out ${optionIndex === activeOptionIndex ? "brightness-100 border-yellow-600" : "brightness-[0.6] hover:brightness-100 hover:border hover:border-yellow-600 hover:rounded-xl"}`}
