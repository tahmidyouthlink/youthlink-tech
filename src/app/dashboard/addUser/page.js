                    ...
                    <form onSubmit={handleRegister} className="p-12 mx-6">
                        ...
                        <div className="space-y-5">
                            ...
                            <div className="relative">
                                <input id="email" type="email" placeholder="example@gmail.com" className="p-3 block w-full pl-10 drop-shadow-lg outline-none bg-white" />
                            ...
                            <div className="relative">
                                <input id="password" type={showPassword ? "text" : "password"} placeholder=".............." className="p-3 block w-full pl-10 drop-shadow-lg outline-none bg-white" />
...
export default AuthorizedRegister;