        ...
        <PrivateRoute>
            ...
            <div className='max-w-screen-xl mx-auto px-6'>
                <div className="items-center gap-4 flex flex-col px-6">
                    ...
                    <div className='flex justify-center py-3'><p className="text-xs px-2 py-1 rounded-lg bg-gray-300 font-medium text-white md:text-sm">{jobDetails?.category}</p></div>
                    <div className='flex justify-center items-center'>
