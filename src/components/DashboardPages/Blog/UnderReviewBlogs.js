...
const UnderReviewBlogs = () => {
    ...
    return (
        <PrivateRoute>
            {
                reviewBlog?.length > 0 ? <div>
                    <h1 className='mt-8 my-4 px-10 font-semibold'>Under Review Blogs</h1>
                    ...
                    <h1 className='mt-8 my-4 px-10 font-semibold'>Under Review Blogs</h1>
                    <h1 className='text-center my-8'>There is no under review blogs</h1>
                </div>
            }
        </PrivateRoute>
    );
